        ...
        if (is_product()) {
            ...
            if ($shop_page_id > 0) {
                ...
                foreach ($terms as $term ) {
                    if($term->name != 'Uncategorized' && $term->name != 'Voir tout' && $term->name != 'Espace PRO') {
                        if($term->name == $breadcrumb[1][0]) {
                            $h2IsGoodName = true;
                        }
                        else {
                            $substituteTitleUrl = get_term_link($term->term_id , 'product_cat');
                            $substituteTitle = $term->name;
                            $h2IsGoodName = false;
                        }
                    }
                }
                if($h2IsGoodName) {
                    ...
                    $h2[0] = $substituteTitle;
                    $h2[1] = $substituteTitleUrl;
                }
